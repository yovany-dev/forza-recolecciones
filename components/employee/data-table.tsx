...
import { TableSkeleton } from "@/components/employee/table-skeleton";
import { Controls } from "@/components/employee/controls";
...
export function DataTable<TData, TValue>({
  ...
  const { pagination, setPagination } = useEmployeeStore();
